                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="jifenJiluJifenStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="jifenJiluJifenChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="jifenJiluJifenEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="jifenJiluJifenChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        积分
                                        <div class="layui-input-inline">
                                            <input type="text" id="jifenStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="jifenChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="jifenEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="jifenChickValue(this)"
                                                   placeholder="结束" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( yonghuIdNumberSearchInput != null){
                ...
                //积分
            var jifenJiluJifenStartSearchInput = $('#jifenJiluJifenStartSearch');
            if(jifenJiluJifenStartSearchInput != null){
                var jifenJiluJifenStartSearchValue = jifenJiluJifenStartSearchInput.val();
                if( jifenJiluJifenStartSearchValue  != 0){
                    searchForm.jifenJiluJifenStart = jifenJiluJifenStartSearchValue;
                }
            }
            var jifenJiluJifenEndSearchInput = $('#jifenJiluJifenEndSearch');
            if(jifenJiluJifenEndSearchInput != null){
                var jifenJiluJifenEndSearchValue = jifenJiluJifenEndSearchInput.val();
                if( jifenJiluJifenEndSearchValue  != 0){
                    searchForm.jifenJiluJifenEnd = jifenJiluJifenEndSearchValue;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("jifenJilu/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                jifenJiluJifenStart: searchForm.jifenJiluJifenStart,
                jifenJiluJifenEnd: searchForm.jifenJiluJifenEnd,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var jifenJiluTypesCell = document.createElement('td');
            jifenJiluTypesCell.innerHTML = item.jifenJiluValue;
            row.appendChild(jifenJiluTypesCell);


            //积分
            var jifenJiluJifenCell = document.createElement('td');
            jifenJiluJifenCell.innerHTML = item.jifenJiluJifen;
            row.appendChild(jifenJiluJifenCell);


                //备注
            var jifenJiluContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.jifenJiluContent && item.jifenJiluContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.jifenJiluContent.indexOf('<img');
                var endIndex = item.jifenJiluContent.indexOf('>');
                    jifenJiluContentCell.innerHTML = item.jifenJiluContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.jifenJiluContent != null && item.jifenJiluContent != "" && item.jifenJiluContent.length >= 11) {
                        jifenJiluContentCell.innerHTML = item.jifenJiluContent.substring(0, 10) + "...";
                } else {
                        jifenJiluContentCell.innerHTML = item.jifenJiluContent;
                }
            }
            row.appendChild(jifenJiluContentCell);
