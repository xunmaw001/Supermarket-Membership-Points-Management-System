                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>类型</label>
                                    <input id="jifenJiluValue" name="jifenJiluValue" class="form-control"
                                           v-model="ruleForm.jifenJiluValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jifenJiluJifen" name="jifenJiluJifen" class="form-control"
                                               v-model="ruleForm.jifenJiluJifen" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.jifenJiluContent != null && ruleForm.jifenJiluContent != 'null' && ruleForm.jifenJiluContent != '') {
            var jifenJiluContentUeditor = UE.getEditor('jifenJiluContentEditor');
                jifenJiluContentUeditor.ready(function () {
                    var mes = '' + ruleForm.jifenJiluContent;
                    jifenJiluContentUeditor.setContent(mes);
                    jifenJiluContentUeditor.setDisabled('fullscreen');
            });
        }
    }
