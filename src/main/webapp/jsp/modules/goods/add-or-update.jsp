                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="goodsNumber" name="goodsNumber" class="form-control"
                                               onchange="goodsNumberChickValue(this)"  placeholder="商品数量">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="danjia" name="danjia" class="form-control"
                                               onchange="danjiaChickValue(this)" placeholder="价格">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>所需积分</label>
                                        <input id="suoxuJifen" name="suoxuJifen" class="form-control"
                                               onchange="suoxuJifenChickValue(this)"  placeholder="所需积分">
                                    </div>
                                    ...
                                    <%--<div class="form-group col-md-6">--%>
                                        ...
                                        <%--<input id="flag" name="flag" class="form-control"--%>
                                               <%--onchange="flagChickValue(this)"  placeholder="是否删除">--%>
                                    <%--</div>--%>
...
<script>
    ...
    //数字检查
        ...
        function suoxuJifenChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[1-9][0-9]*$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                goodsName: "商品名字不能为空",
                goodsTypes: "商品种类不能为空",
                goodsNumber: "商品数量不能为空",
                goodsPhoto: "商品图片不能为空",
                danwei: "单位不能为空",
                danjia: "价格不能为空",
                suoxuJifen: "所需积分不能为空",
                goodsContent: "商品详情不能为空",
                flag: "是否删除不能为空",
            }
        }).form();
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            // 所需积分设置不可选
            // $('#suoxuJifen').attr('readonly', 'readonly');
        }else{
            // alert("未知情况.......");
        }
    }
